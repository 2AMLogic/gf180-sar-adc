...
| SFDR @ Nyquist | ≥ 62 dB | ≥ 65 dB | `ss_125c_2.97v` (schematic, 61.33 dB) / `ff_125c_3.63v` (extracted, governing, 64.38 dB) — acquisition sampling-bow nonlinearity, not R_on-modulation ([testbench-suite-memo.md §11.2](spec/testbench-suite-memo.md), reconciled by #151); margin derivation in note **[a]** |
